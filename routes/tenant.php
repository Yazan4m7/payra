...
Route::middleware(['web', InitializeTenancyByDomain::class, PreventAccessFromCentralDomains::class, ScopeSessions::class, 'locale'])->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware('tenant.role:company_admin,hr')->group(function () {
            ...
            Route::get('/terminations', TerminationsIndex::class)->name('terminations.index');
            Route::get('/holidays', HolidaysIndex::class)->name('holidays.index');
            Route::get('/payroll/{run}/bank-export', BankExportController::class)->name('payroll.bank-export');
            Route::get('/compliance-settings', ComplianceSettings::class)->name('compliance.settings');
